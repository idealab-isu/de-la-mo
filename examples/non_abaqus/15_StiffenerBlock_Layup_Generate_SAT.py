...
# Set layer thickness
thickness = 0.199
cad_file_name = "ACIS_Example03.sat"
...
list12 = acis.adjacent_layers(layer1, layer2, "data/Delamination1_3D.csv", delamo.CADwrap.BC_CONTACT)
...
# Bond Layers 2 and 3
list23 = acis.adjacent_layers(layer2, layer3, delamo.CADwrap.BC_CONTACT)
...
# Bond Layers 3 and 4
list34 = acis.adjacent_layers(layer3, layer4, delamo.CADwrap.BC_CONTACT)

# Create a stiffener
stiffener = delamo.CADwrap.Layer()
acis.create_hat_stiffener(layer4, stiffener, "data/HatStiffener.csv")

# Bond the stiffener
acis.adjacent_layers(layer4, stiffener, delamo.CADwrap.BC_CONTACT)

# Create 5th layer
# Since the stiffener is bonded to the 4th layer, the 5 layer would follow the stiffener contour
...
# Bond Layers 4 and 5 and add a delamination under the stiffener
list45 = acis.adjacent_layers(layer4, layer5, "data/Delamination1_3D.csv", delamo.CADwrap.BC_CONTACT)
...
# Bond Layers 5 and 6
list56 = acis.adjacent_layers(layer5, layer6, delamo.CADwrap.BC_CONTACT)
...
# Bond Layers 6 and 7
list67 = acis.adjacent_layers(layer6, layer7, delamo.CADwrap.BC_CONTACT)
...
# Bond Layers 7 and 8
list78 = acis.adjacent_layers(layer7, layer8, delamo.CADwrap.BC_CONTACT)

# Put the layers into a std::vector implementation
